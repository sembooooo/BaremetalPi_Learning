...
_start: 0
;-------------------------------------------------------------------------------
;=======================setting the stack for all the three cores===============
;-------------------------------------------------------------------------------

;====================================
;@ this sets stack pointer for core 0
;==================================== 
	ldr r4,=CORE0
	...
	beq set_stack_func
;====================================
;@ this sets stack pointer for core 1
;====================================
	...
	beq set_stack_func
;====================================
;@ this sets stack pointer for core 2
;====================================
	...
	beq set_stack_func
;====================================
;@ this sets stack pointer for core 3
;==================================== 
	...
	b mailbox
;=======================================
;@making cores loop on mailbox address
;=======================================
 	loop_in_mailbox:
