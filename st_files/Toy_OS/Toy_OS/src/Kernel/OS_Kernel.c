...
#include<stdint.h>
#endif 
#include "../../Toy_OS/api/OS_Config.h"
#include "../../Toy_OS/api/OS.h"
#include "../../Toy_OS/api/OS_Kernel.h"
...
Fucntion summary:
 ...
 @return : returns 1 
*/
uint32_t OS_AddThreads(void(*task0)(void), void(*task1)(void), void(*task2)(void)) /* TODO: remove this fucntion once ToyOS_CreateTask is completed */
	{  
